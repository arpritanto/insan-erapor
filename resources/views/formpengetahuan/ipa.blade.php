...
@section('dropdown')
    ...
    <h6 class="m-0 font-weight-bold text-primary">Mata Pelajaran IPA</h6>
        ...
        @foreach ($pengetahuan as $p)
            <tr style="text-align: center">
                ...
                <td style="text-align: center;">
                    ...
                    <a href="/pengetahuan_ipa/{{ $p->id }}/delete" class="btn btn-danger btn-icon-split">
            ...
            <div class="modal fade" id="ModalEdit{{ $p->id }}" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog" role="document">
                    <form method="POST" action="{{ url('/pengetahuan_ipa/' . $p->id . '/edit') }}" autocomplete="off"
                        class="sign-up-form">
                        @csrf
...
@section('add')
    <form method="POST" action="/pengetahuan_ipa/create" autocomplete="off" class="sign-up-form">
        @csrf
        <div class="modal-content">
            <div class="modal-header">
