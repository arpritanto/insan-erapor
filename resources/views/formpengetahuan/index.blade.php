    ...
    <tbody>
        ...
        <tr style="text-align: center">
            ...
            <td style="text-align: center;">
                ...
                <div class="modal fade" id="ModalEdit{{ $p->NISN }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <form method="POST" action="/pengetahuan/{{ $p->NISN }}/edit" autocomplete="off" class="sign-up-form">
                            @csrf
