...
@section('dropdown')
    ...
    <h6 class="m-0 font-weight-bold text-primary">Mata Pelajaran B.INDO</h6>
    <div class="dropright mb-4">
        ...
        <div class="dropdown-menu animated--fade-in" aria-labelledby="dropdownMenuButton">
            <a class="dropdown-item" href="/pengetahuan_pai">PAI</a>
            <a class="dropdown-item" href="/pengetahuan_ppkn">PPKN</a>
            <a class="dropdown-item" href="/pengetahuan_bindo">B.IND</a>
            <a class="dropdown-item" href="/pengetahuan_mat">MAT</a>
            <a class="dropdown-item" href="/pengetahuan_ipa">IPA</a>
            <a class="dropdown-item" href="/pengetahuan_ips">IPS</a>
            <a class="dropdown-item" href="/pengetahuan_sbdp">SBdP</a>
            <a class="dropdown-item" href="/pengetahuan_pjok">PJOK</a>
        </div>
        ...
        @foreach ($pengetahuan as $p)
            <tr style="text-align: center">
                ...
                <td style="text-align: center;">
                    ...
                    <a href="/pengetahuan_bindo/{{ $p->id }}/delete" class="btn btn-danger btn-icon-split">
            ...
            <div class="modal fade" id="ModalEdit{{ $p->id }}" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog" role="document">
                    <form method="POST" action="{{ url('/pengetahuan_bindo/' . $p->id . '/edit') }}" autocomplete="off"
                        class="sign-up-form">
                        @csrf
...
@section('add')
    <form method="POST" action="/pengetahuan_bindo/create" autocomplete="off" class="sign-up-form">
        @csrf
        <div class="modal-content">
            <div class="modal-header">
