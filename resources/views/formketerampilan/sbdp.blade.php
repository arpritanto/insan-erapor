        ...
        @foreach ($keterampilan as $k)
            <tr style="text-align: center">
                ...
                <td style="text-align: center;">
                    ...
                    <a href="/keterampilan_sbdp/{{ $k->id }}/delete" class="btn btn-danger btn-icon-split">
            ...
            <div class="modal fade" id="ModalEdit{{ $k->id }}" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog" role="document">
                    <form method="POST" action="{{ url('/keterampilan_sbdp/' . $k->id . '/edit') }}" autocomplete="off"
                        class="sign-up-form">
                        @csrf
...
@section('add')
    <form method="POST" action="/keterampilan_sbdp/create" autocomplete="off" class="sign-up-form">
        @csrf
        <div class="modal-content">
            <div class="modal-header">
