...
@section('table-content')
    ...
    <tbody>
        ...
        @foreach ($keterampilan as $k)
            ...
            <div class="modal fade" id="ModalEdit{{ $k->NISN }}" role="dialog" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <form method="POST" action="{{ url('/keterampilan/' . $k->NISN . '/edit') }}" autocomplete="off"
                        class="sign-up-form">
                        @csrf
